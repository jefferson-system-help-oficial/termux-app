...
/**
 * Work around for fullscreen mode in GoldBOX to fix ExtraKeysView not being visible.
...
public class FullScreenWorkAround {
    ...
    public static void apply(GoldBOXActivity activity) {
        new FullScreenWorkAround(activity);
    }

    private FullScreenWorkAround(GoldBOXActivity activity) {
