...
import com.goldbox.view.textselection.TextSelectionCursorController;
...
public final class TerminalView extends View {
    ...
    public InputConnection onCreateInputConnection(EditorInfo outAttrs) {
        ...
        if (mClient.isTerminalViewSelected()) {
            if (mClient.shouldEnforceCharBasedInput()) {
                ...
                // https://github.com.goldbox/goldbox-app/issues/686
                ...
                // https://github.com.goldbox/goldbox-packages/issues/25
                // https://github.com.goldbox/goldbox-app/issues/87.
                // https://github.com.goldbox/goldbox-app/issues/126.
                // https://github.com.goldbox/goldbox-app/issues/137 (japanese chars and TYPE_NULL).
        ...
        // keyboard on Android TV (see https://github.com.goldbox/goldbox-app/issues/221).
     ...
     * https://github.com.goldbox/goldbox-app/pull/2237
     * https://github.com/agnostic-apollo/goldbox-app/blob/terminal-code-point-custom-mapping/terminal-view/src/main/java/com.goldbox/view/TerminalView.java
     *
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        ...
        // https://github.com.goldbox/goldbox-app/issues/731
     ...
     * {@link com.goldbox.terminal.TerminalSessionClient#onTerminalCursorStateChange(boolean)}
    ...
    protected void onDetachedFromWindow() {
        ...
        if (mTextSelectionCursorController != null) {
            ...
            // android.view.WindowLeaked: Activity com.goldbox.app.GoldBOXActivity has leaked window android.widget.PopupWindow
            stopTextSelectionMode();
