package com.goldbox.shared.goldbox.terminal;
...
public class GoldBOXTerminalSessionClientBase implements TerminalSessionClient {

    public GoldBOXTerminalSessionClientBase() {
    }
