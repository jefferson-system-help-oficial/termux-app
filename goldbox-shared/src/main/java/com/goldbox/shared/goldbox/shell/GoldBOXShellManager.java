...
public class GoldBOXShellManager {

    private static GoldBOXShellManager shellManager;
    ...
    /**
     * The foreground GoldBOXSessions which this service manages.
     * Note that this list is observed by an activity, like GoldBOXActivity.mGoldBOXSessionListViewController,
     * so any changes must be made on the UI thread and followed by a call to
     * {@link ArrayAdapter#notifyDataSetChanged()}.
     */
    public final List<GoldBOXSession> mGoldBOXSessions = new ArrayList<>();

    /**
     * The background GoldBOXTasks which this service manages.
     */
    public final List<AppShell> mGoldBOXTasks = new ArrayList<>();
    ...
    public GoldBOXShellManager(@NonNull Context context) {
     ...
     * @return Returns the {@link GoldBOXShellManager}.
     */
    public static GoldBOXShellManager init(@NonNull Context context) {
        if (shellManager == null)
            shellManager = new GoldBOXShellManager(context);
     ...
     * @return Returns the {@link GoldBOXShellManager}.
     */
    public static GoldBOXShellManager getShellManager() {
        return shellManager;
    }
