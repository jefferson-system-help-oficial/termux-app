package com.goldbox.shared.activities;
 ...
 * {@code `<activity android:name="com.goldbox.shared.activities.ReportActivity" android:theme="@style/Theme.AppCompat.GoldBOXReportActivity" android:documentLaunchMode="intoExisting" />` }
 * and
 * {@code `<receiver android:name="com.goldbox.shared.activities.ReportActivity$ReportActivityBroadcastReceiver"  android:exported="false" />` }
    ...
    private void updateUI() {
        ...
        if (actionBar != null) {
            if (mReportInfo.reportTitle != null)
                ...
                actionBar.setTitle(GoldBOXConstants.GOLDBOX_APP_NAME + " App Report");
        }
