package com.goldbox.shared.shell.command;
...
public class ExecutionCommand {
    ...
    Only the {@link #errCode} being non-zero means that execution command failed from the GoldBOX app
    perspective.
    */
     ...
     * commands. By default, @link com.goldbox.shared.shell.StreamGobbler} only logs stdout and
    ...
    /** Defines the markdown text for the help of the GoldBOX plugin API that was used to start the
     ...
     * like with an intent or from within GoldBOX app itself. */
